    ...
    try {
        ...
        const response = await client.models.generateContent({
            ...
            config: {
                ...
                Часть 2 (ТАЙНОЕ ОТКРОВЕНИЕ): Подробный, плотный текст (не менее 120-150 слов).
                
                ВАЖНО: Вторая часть должна быть очень длинной, чтобы в интерфейсе заблюренная область выглядела как массивный и ценный контент. Пиши про финансы, отношения, опасности дня и конкретные советы.
                
                СТИЛЬ: Пронзительный мистицизм. Тон: роковой, серьезный.`,
                temperature: 1.0,
                seed: randomSeed,
                safetySettings: [
